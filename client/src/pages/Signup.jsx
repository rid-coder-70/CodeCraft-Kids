  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.token) {
        ...
        toast("Welcome to CodeCraft Kids! 🎉 Let's start coding!", "success");
        navigate("/dashboard");
      } else {
    ...
    <div className="min-h-[calc(100vh-6rem)] bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Create your CodeCraft Kids account
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 sm:rounded-2xl sm:px-10 border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
          ...
          <div className="mt-6 text-center text-sm font-medium">
            ...
            <Link to="/login" className="text-green-600 hover:text-green-500 ml-1">
              Log in here
            </Link>
          </div>
        </div>
